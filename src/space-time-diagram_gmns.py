    ...
    with open('node.csv', 'r') as fp:
        ...
        for l in lines[1:]:
            ...
            try:
                ...
                node.x_corrd = int(l[index_x_corrd])
                node.y_coord = int(l[index_y_coord])
    ...
    with open('road_link.csv', 'r') as fp:
        ...
        for l in lines[1:]:
            ...
            try:
                ...
                print('Fail to read the input raod link file.')
        print('number of raod links:{}'.format(g_number_of_road_links))
...
def g_draw_space_time_diagram():
    ...
    # obtain the y axix location and name
